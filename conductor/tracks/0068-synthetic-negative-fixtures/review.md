# Review: Synthetic negative fixture generator

## Implementation status

- Track: `0068-synthetic-negative-fixtures`.
- Capability: `M-068`.
- Metadata status: `implemented_scaffold`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/0068-synthetic-negative-fixtures-review.md`.
