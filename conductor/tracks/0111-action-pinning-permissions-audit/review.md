# Review: GitHub Actions pinning and permissions audit

## Implementation status

- Track: `0111-action-pinning-permissions-audit`.
- Capability: `M-111`.
- Metadata status: `implemented_python`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/111-action-pinning-permissions-audit-review.md`.
