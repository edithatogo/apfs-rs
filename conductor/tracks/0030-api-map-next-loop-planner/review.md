# Review: Cargoless API map and next-loop planning tools

## Implementation status

- Track: `0030-api-map-next-loop-planner`.
- Capability: `M-030`.
- Metadata status: `implemented_scaffold`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/0030-m-030-cargoless-api-map-and-next-loop-planning-tools-review.md`.
