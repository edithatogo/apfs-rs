# Review: Profiling and benchmark scaffold

## Implementation status

- Track: `0096-profiling-and-benchmark-scaffold`.
- Capability: `M-096`.
- Metadata status: `scaffolded`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/0096-profiling-and-benchmark-scaffold-review.md`.
