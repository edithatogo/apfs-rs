# Review: 0007-m006-single-node-omap-lookup: M-006

## Implementation status

- Track: `0007-m006-single-node-omap-lookup`.
- Capability: `M-006`.
- Metadata status: `implemented_in_package_uncompiled`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/0006-single-node-omap-lookup-review.md`.
