# Review: Tool capability matrix and fallback command planner

## Implementation status

- Track: `0082-tool-capability-matrix-and-fallback-command-planne`.
- Capability: `M-082`.
- Metadata status: `implemented_python`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/082-m-082-tool-capability-matrix-and-fallback-command-planner-review.md`.
