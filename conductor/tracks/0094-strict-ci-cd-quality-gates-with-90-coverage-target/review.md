# Review: Strict CI/CD quality gates with >=90% coverage target

## Implementation status

- Track: `0094-strict-ci-cd-quality-gates-with-90-coverage-target`.
- Capability: `M-094`.
- Metadata status: `scaffolded`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/0094-strict-ci-cd-quality-gates-with-90-coverage-target-review.md`.
