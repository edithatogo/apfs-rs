# Review: Current environment capability inventory

## Implementation status

- Track: `0065-current-environment-inventory`.
- Capability: `M-065`.
- Metadata status: `implemented_scaffold`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/0065-current-environment-inventory-review.md`.
