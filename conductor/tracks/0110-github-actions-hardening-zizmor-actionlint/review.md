# Review: GitHub Actions hardening with zizmor/actionlint policy

## Implementation status

- Track: `0110-github-actions-hardening-zizmor-actionlint`.
- Capability: `M-110`.
- Metadata status: `implemented_python`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/110-github-actions-hardening-zizmor-actionlint-review.md`.
