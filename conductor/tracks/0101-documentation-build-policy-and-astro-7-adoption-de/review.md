# Review: Documentation build policy and Astro 7 adoption decision

## Implementation status

- Track: `0101-documentation-build-policy-and-astro-7-adoption-de`.
- Capability: `M-101`.
- Metadata status: `scaffolded`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/0101-documentation-build-policy-and-astro-7-adoption-de-review.md`.
