# Review: SLSA and artifact attestation verification plan

## Implementation status

- Track: `0113-slsa-attestation-verification`.
- Capability: `M-113`.
- Metadata status: `implemented_python`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/113-slsa-attestation-verification-review.md`.
