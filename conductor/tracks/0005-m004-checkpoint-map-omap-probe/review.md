# Review: 0005-m004-checkpoint-map-omap-probe: M-004

## Implementation status

- Track: `0005-m004-checkpoint-map-omap-probe`.
- Capability: `M-004`.
- Metadata status: `implemented_in_package_uncompiled`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/0004-checkpoint-map-and-omap-probe-review.md`.
