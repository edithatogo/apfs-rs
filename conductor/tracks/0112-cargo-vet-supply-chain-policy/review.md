# Review: cargo-vet supply-chain review policy

## Implementation status

- Track: `0112-cargo-vet-supply-chain-policy`.
- Capability: `M-112`.
- Metadata status: `implemented_python`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/112-cargo-vet-supply-chain-policy-review.md`.
