# Review: Cargoless golden-output expectation generator

## Implementation status

- Track: `0078-golden-output-expectations`.
- Capability: `M-078`.
- Metadata status: `implemented_python`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/078-golden-output-expectations-review.md`.
