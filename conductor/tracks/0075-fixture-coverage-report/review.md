# Review: 0075-fixture-coverage-report: Fixture coverage gap report

## Implementation status

- Track: `0075-fixture-coverage-report`.
- Capability: `M-075`.
- Metadata status: `implemented`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/075-0075-fixture-coverage-report-review.md`.
