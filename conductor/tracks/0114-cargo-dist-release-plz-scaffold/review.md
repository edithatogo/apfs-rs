# Review: cargo-dist and release-plz automation scaffold

## Implementation status

- Track: `0114-cargo-dist-release-plz-scaffold`.
- Capability: `M-114`.
- Metadata status: `implemented_python`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/114-cargo-dist-release-plz-scaffold-review.md`.
