# Review: Redacted diagnostics bundle generator

## Implementation status

- Track: `0028-redacted-diagnostics-bundle`.
- Capability: `M-028`.
- Metadata status: `implemented_scaffold`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/0028-m-028-redacted-diagnostics-bundle-generator-review.md`.
