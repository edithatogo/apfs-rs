# Review: 0073-cargoless-smoke-suite: Cargoless smoke suite aggregator

## Implementation status

- Track: `0073-cargoless-smoke-suite`.
- Capability: `M-073`.
- Metadata status: `implemented`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/073-0073-cargoless-smoke-suite-review.md`.
