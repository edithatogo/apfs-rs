# Review: Local migration command generator

## Implementation status

- Track: `0092-local-migration-command-generator`.
- Capability: `M-092`.
- Metadata status: `implemented_python`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/0092-local-migration-command-generator-review.md`.
