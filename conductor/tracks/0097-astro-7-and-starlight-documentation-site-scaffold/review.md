# Review: Astro 7 and Starlight documentation site scaffold

## Implementation status

- Track: `0097-astro-7-and-starlight-documentation-site-scaffold`.
- Capability: `M-097`.
- Metadata status: `scaffolded`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/0097-astro-7-and-starlight-documentation-site-scaffold-review.md`.
