# Review: Xattr and resource fork readiness

## Implementation status

- Track: `0035-xattr-resource-fork-readiness`.
- Capability: `M-035`.
- Metadata status: `implemented_scaffold`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/0035-xattr-resource-fork-readiness-review.md`.
