# Review: 0016-synthetic-directory-root-tree: M-016

## Implementation status

- Track: `0016-synthetic-directory-root-tree`.
- Capability: `M-016`.
- Metadata status: `implemented_in_package_uncompiled`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/0015-m015-synthetic-directory-root-tree-review.md`.
