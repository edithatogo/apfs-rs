# Review: Windows read-only adapter readiness scaffold

## Implementation status

- Track: `0027-windows-readiness-scaffold`.
- Capability: `M-027`.
- Metadata status: `implemented_scaffold`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/0027-m-027-windows-read-only-adapter-readiness-scaffold-review.md`.
