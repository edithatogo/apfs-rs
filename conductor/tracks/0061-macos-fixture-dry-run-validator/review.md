# Review: macOS APFS fixture dry-run validator

## Implementation status

- Track: `0061-macos-fixture-dry-run-validator`.
- Capability: `M-061`.
- Metadata status: `completed_scaffold`.
- Spec and plan are present in this Conductor track.
- Codev review: `codev/reviews/0061-macos-fixture-dry-run-validator-review.md`.
