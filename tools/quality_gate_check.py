...
REQ_TERMS={
    '.github/workflows/quality-gates.yml':['fail-under-lines 90','cargo nextest','cargo fuzz','cargo mutants'],
    ...
    '.github/workflows/coverage.yml':['fail-under-lines 90'],
    ...
    '.github/workflows/docs-site.yml':['npm install','npm run build'],
